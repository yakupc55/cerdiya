...
var app = (function () {
    ...
    const file$1 = "src\\AddFile.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*FileList*/ 1 && t0_value !== (t0_value = /*FileList*/ ctx[0].length + "")) set_data_dev(t0, t0_value);
    ...
    // (23:1) <Link to="/" class="navbar-brand" >
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(23:1) <Link to=\\\"/\\\" class=\\\"navbar-brand\\\" >",
    		ctx
    	});
    ...
    // (29:2) <Link to="addFile" class="nav-item nav-link active" >
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(29:2) <Link to=\\\"addFile\\\" class=\\\"nav-item nav-link active\\\" >",
    		ctx
    	});
    ...
    // (21:0) <Router url="{url}" basepath={basepath}>
    function create_default_slot(ctx) {
    	...
    	route0 = new Route({
    			props: { path: "addFile", component: AddFile },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 24, 2, 1227);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(21:0) <Router url=\\\"{url}\\\" basepath={basepath}>",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$3, 17, 1, 452);
    			...
    			add_location(script, file$3, 18, 1, 664);
    			add_location(head, file$3, 16, 0, 444);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
