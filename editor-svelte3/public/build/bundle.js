...
var app = (function () {
    ...
    // (32:2) <Link to="/" class="navbar-brand" >
    function create_default_slot_5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:2) <Link to=\\\"/\\\" class=\\\"navbar-brand\\\" >",
    		ctx
    	});
    ...
    // (38:3) <Link to="addFile" class="nav-item nav-link active" >
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(38:3) <Link to=\\\"addFile\\\" class=\\\"nav-item nav-link active\\\" >",
    		ctx
    	});
    ...
    // (39:3) <Link to="fileStructure" class="nav-item nav-link active" >
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(39:3) <Link to=\\\"fileStructure\\\" class=\\\"nav-item nav-link active\\\" >",
    		ctx
    	});
    ...
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(44:2) <Route path=\\\"addFile\\\" >",
    		ctx
    	});
    ...
    // (30:1) <Router url="{url}" basepath={basepath}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$5, 33, 4, 1539);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:1) <Router url=\\\"{url}\\\" basepath={basepath}>",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$5, 26, 2, 749);
    			...
    			add_location(script, file$5, 27, 2, 963);
    			add_location(head, file$5, 25, 1, 739);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
