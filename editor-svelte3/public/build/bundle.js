...
var app = (function () {
    ...
    /* src\FileStructure.svelte generated by Svelte v3.48.0 */

    const file = "src\\FileStructure.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Structure page";
    			add_location(h1, file, 3, 0, 27);
    		},
    ...
    function instance($$self, $$props) {
    	...
    	validate_slots('FileStructure', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<FileStructure> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class FileStructure extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "This a home page";
    ...
    /* src\AddFile.svelte generated by Svelte v3.48.0 */

    const { console: console_1 } = globals;
    const file$3 = "src\\AddFile.svelte";
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 118, 0, 3786);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(h2, file$3, 113, 0, 3591);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			append_dev(h2, t0);
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*FileList*/ 1) && t0_value !== (t0_value = /*FileList*/ ctx[0].length + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*deleteFile, FileList, faCircleMinus*/ 5) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(113:0) {#if FileList.length>0}",
    		ctx
    	});
    ...
    // (115:0) {#each FileList as item, index}
    function create_each_block(ctx) {
    	let h4;
    	let t0;
    	let t1;
    	let t2_value = /*item*/ ctx[7].name + "";
    	let t2;
    	let t3;
    	let div;
    	let fa;
    	...
    	fa = new Fa({
    			props: { icon: faCircleMinus, color: "red" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 115, 25, 3677);
    			add_location(h4, file$3, 115, 0, 3652);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*deleteFile*/ ctx[2](/*item*/ ctx[7].path))) /*deleteFile*/ ctx[2](/*item*/ ctx[7].path).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*FileList*/ 1) && t2_value !== (t2_value = /*item*/ ctx[7].name + "")) set_data_dev(t2, t2_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(115:0) {#each FileList as item, index}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*FileList*/ ctx[0].length > 0) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block.c();
    			if_block_anchor = empty();
    			add_location(button, file$3, 108, 0, 3480);
    			add_location(h1, file$3, 109, 0, 3537);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	document.addEventListener('drop', event => {
    		...
    		$$invalidate(0, FileList = [...FileList, ...files]);
    	});
    	...
    	const deleteFile = path => {
    		$$invalidate(0, FileList = FileList.filter(x => x.path != path));
    	};

    	const writable_props = ['FileList'];
    	...
    	return [FileList, addFileFunction, deleteFile];
    }

    class AddFile extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { FileList: 0 });
    	...
    	get FileList() {
    		throw new Error("<AddFile>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set FileList(value) {
    		throw new Error("<AddFile>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    // (25:2) <Link to="/" class="navbar-brand" >
    function create_default_slot_5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(25:2) <Link to=\\\"/\\\" class=\\\"navbar-brand\\\" >",
    		ctx
    	});
    ...
    // (31:3) <Link to="addFile" class="nav-item nav-link active" >
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(31:3) <Link to=\\\"addFile\\\" class=\\\"nav-item nav-link active\\\" >",
    		ctx
    	});
    ...
    // (32:3) <Link to="fileStructure" class="nav-item nav-link active" >
    function create_default_slot_3(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("file structure");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:3) <Link to=\\\"fileStructure\\\" class=\\\"nav-item nav-link active\\\" >",
    		ctx
    	});
    ...
    // (37:2) <Route path="addFile" >
    function create_default_slot_2(ctx) {
    	let addfile;
    	let current;
    	addfile = new AddFile({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(addfile.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(addfile, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(addfile.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(addfile.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(addfile, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(37:2) <Route path=\\\"addFile\\\" >",
    		ctx
    	});
    ...
    // (23:1) <Router url="{url}" basepath={basepath}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$5, 26, 4, 1310);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(23:1) <Router url=\\\"{url}\\\" basepath={basepath}>",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$5, 19, 2, 527);
    			...
    			add_location(script, file$5, 20, 2, 740);
    			add_location(head, file$5, 18, 1, 518);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
