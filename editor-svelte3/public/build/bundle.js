...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "This a test page";
    ...
    function instance$1($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<AddFile> was created with unknown prop '${key}'`);
    	});
    ...
    // (23:2) <Link to="/" class="navbar-brand" >
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(23:2) <Link to=\\\"/\\\" class=\\\"navbar-brand\\\" >",
    		ctx
    	});
    ...
    // (29:3) <Link to="addFile" class="nav-item nav-link active" >
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(29:3) <Link to=\\\"addFile\\\" class=\\\"nav-item nav-link active\\\" >",
    		ctx
    	});
    ...
    // (21:1) <Router url="{url}" basepath={basepath}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 24, 4, 1238);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(21:1) <Router url=\\\"{url}\\\" basepath={basepath}>",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$3, 17, 2, 455);
    			...
    			add_location(script, file$3, 18, 2, 668);
    			add_location(head, file$3, 16, 1, 446);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
